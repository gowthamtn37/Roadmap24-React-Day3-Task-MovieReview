...
const formvalidationschema = yup.object({
  ...
  poster: yup.string().required("Add this Poster url").min(4).url(),

  summary: yup.string().required("fill this Summary").min(20),

  rating: yup.number().required("Add this Rating").min(0).max(20),

  trailer: yup.string().min(4).required("Add this trailer url").url(),
});
